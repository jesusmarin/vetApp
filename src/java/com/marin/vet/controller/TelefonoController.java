...
public class TelefonoController implements Serializable {
    ...
    @EJB
    private com.marin.vet.facade.TelefonoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("TelefonoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("TelefonoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("TelefonoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
        }
    }
