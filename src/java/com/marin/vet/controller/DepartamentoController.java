...
import com.marin.vet.facade.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private com.marin.vet.facade.DepartamentoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("DepartamentoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("DepartamentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("DepartamentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
        }
    }
