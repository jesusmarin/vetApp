...
public class MascotaController implements Serializable {
    ...
    @EJB
    private com.marin.vet.facade.MascotaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("MascotaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("MascotaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("MascotaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
        }
    }
