...
public class RazaController implements Serializable {
    ...
    private Raza current;
    private DataModel items = null;
    @EJB
    private com.marin.vet.facade.RazaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Raza) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("RazaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("RazaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("RazaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("com/marin/vet/bundle/b").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class RazaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Raza) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Raza.class.getName());
            }
        }
